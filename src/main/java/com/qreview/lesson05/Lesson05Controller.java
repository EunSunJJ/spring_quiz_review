...
import com.qreview.lesson05.model.Member;
...
public class Lesson05Controller {
	...
	@RequestMapping("/quiz03_1")
	//  http://localhost:8080/lesson05/quiz03_1
	public String quiz03_1(Model model) {
		...
		model.addAttribute("total", 1000000);
	...
	//  http://localhost:8080/lesson05/quiz03_2
